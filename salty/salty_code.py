...
input o_state : Int = 14
output a_state : Int = 0
env_trans
    o_state = 0 -> \/(o_state' = 1)\/(o_state' = 4)\/(o_state' = 0)
    o_state = 4 -> \/(oo_state' = 0)\/(o_state' = 8)\/(o_state' = 4)\/(o_state' = 5)
    o_state = 8 -> \/(oo_state' = 4)\/(o_state' = 12)\/(o_state' = 8)\/(o_state' = 9)
    ...
    a_state = 4 -> \/(oo_state' = 0)\/(a_state' = 8)\/(a_state' = 4)\/(a_state' = 5)
    a_state = 8 -> \/(oo_state' = 4)\/(a_state' = 12)\/(a_state' = 8)\/(a_state' = 9)
